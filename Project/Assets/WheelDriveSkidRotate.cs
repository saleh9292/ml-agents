...
public class WheelDriveSkidRotate : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        m_Legs[0].transform.rotation *= Quaternion.AngleAxis(-RotateFR * maxRotationspeed, Vector3.forward);
        m_Legs[1].transform.rotation *= Quaternion.AngleAxis(-RotateBR * maxRotationspeed, Vector3.forward);
        m_Legs[2].transform.rotation *= Quaternion.AngleAxis(RotateFL * maxRotationspeed , Vector3.forward);
        m_Legs[3].transform.rotation *= Quaternion.AngleAxis(RotateBL * maxRotationspeed , Vector3.forward);
